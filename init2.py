...
Code for argparser and running the code on different datasets
...
parser.add_argument('--num_learners', type = int, default = 2, help = 'number of learners embedding space is divided into')
...
parser.add_argument('--model_dict_path', default = './model_dict_k_2_40_SOP.pth', help = 'file in which model parameters are saved')

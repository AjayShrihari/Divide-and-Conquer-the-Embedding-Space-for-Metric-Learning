...
parser.add_argument('--batch_sz', type = int, default = 20, help = 'batch size for complete dataset')
parser.add_argument('--cluster_batch_sz', type = int,default = 20, help = 'batch size for each cluster')
...
parser.add_argument('--initial_epochs', type = int, default = 2, help = 'train full learner for initial_epochs')
parser.add_argument('--num_epochs', type = int, default = 1, help = 'number of epochs')
parser.add_argument('--num_epochs_cluster', type = int, default =1, help = 'number of epochs per cluster')
parser.add_argument('--num_T', type = int, default = 2, help = 'each cluster is trained num_T times before joining back learners')
...
parser.add_argument('--debug', type = bool, default = True, help = 'debug option')

parser.add_argument('--save_model', type = bool, default = True, help = 'svae model?')
